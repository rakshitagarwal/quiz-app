          ...
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4"
              >
                Sign in with Github
              </button>
